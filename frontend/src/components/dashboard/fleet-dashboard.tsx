...
// ---------------------------------------------------------------------------
// Fleet dashboard — the plant module's home. Rendered at "/" for admins and
// plant officers, and as the first tab of the Plant workbench for management.
// ---------------------------------------------------------------------------
export function FleetDashboard({ title, subtitle }: {
  title?: string
  subtitle?: string
} = {}) {
  const { user } = useAuth()
